        ...
        <div className="grid grid-cols-1 place-items-center  justify-center items-center">
          <div className="m-6 sm:m-10">
            ...
            <div className="m-5 grid grid-cols-1 justify-center text-md sm:text-xl md:text-2xl mt-4 text-green-400 font-mono">
              <div>Following are the playlists. In order to share this page to a friend, copy this link: <div className="hover:cursor-pointer text-gray-300 transition duration-200  hover:text-gray-100 line-clamp-1" onClick = {select_url}>{window.location.href}</div> </div>
              <div>If you want to export this data to your accounts, copy this code and choose platform: <div className="hover:cursor-pointer text-gray-300 transition duration-200  hover:text-gray-100" onClick = {select_code}>{window.location.hash.substring(1)}</div></div>
            </div>
          </div>
          <div>
